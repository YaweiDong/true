                  ...
                  <section class="menu_right">
                      <ul>
                          <li v-for="(data,index) in data" :key="data.id">
                              ...
                              <!-- 商品信息 -->
                              <section class="menu_detail_list" v-for="(k,ind) in data.foods" :key="ind">
                                   <router-link :to="{name:'shop_business',params:{id:data.id}}">
              ...
              <section class="buy_car_container">
                 <section>
                      <div class="cart_icon_container">
                            <img class="cart_icon_img" src="../../../../static/imgs/购物车.png" alt="">
                                  ...
                                  <div class="food_img_div">
                                     <ul class="food_img_ul">
                                         <li class="food_img_li" v-for="(kkk,index) in data3.item_ratings" :key="index">
                                             <img v-if="data3" :src="'//elm.cangdu.org/img/'+kkk.image_hash" alt="">
...
export default {
  ...
  computed: {
    ...
    //           total = total + this.data.foods[i]+'{{k.specfoods[0].price}}'* this.dat.foods[i]+'{{count}}';
    //       }
    //       return total;
    //   }
  },
